...
import "./Hero.css";
import resume from "../../../assets/resume/Black White Minimalist CV Resume (1).pdf";
    ...
    <div className="relative mb-10 hero">
      <div className="text-center z-10 relative  py-8 ">
        <h1 className="text-6xl text-white font-bold">
          Hi, I'm
          <span className="text-cyan-400"> Dipro Paul</span>
        </h1>

        <h3 className="md:text-4xl text-2xl flex mx-auto justify-center font-bold text-white">
          <span className="mx-3">I am a</span>{" "}
          <Typewriter
            options={{
              strings: [
                "Web Developer",
        ...
        <Link to={resume} target="_blank" download>
          <button className="my-4 px-4 py-2 rounded-full font-semibold bg-gradient-to-r from-purple-500 to-pink-500 text-white">
            Download My Resume
          </button>
        </Link>
      ...
      <div className="backdrop-blur-lg   box-shadow  bg-gradient-to-r md:bg-gradient-to-t from-fuchsia-800 to-blue-800 md:w-10 w-72 h-12 md:h-72 absolute left-0 md:left-0 bottom-0 md:top-40 rounded-r-lg">
        <div className="flex flex-row md:flex-col gap-x-5 items-center gap-y-0 md:gap-y-5 justify-center">
          <a
            target={"_blank"}
            rel="noreferrer"
            href="https://www.linkedin.com/in/dipro-paul-5308a8259/"
            title="Twitter"
          ...
          <a
            target={"_blank"}
            rel="noreferrer"
            href="https://www.facebook.com/profile.php?id=100078072293427&mibextid=ZbWKwL"
            title="Facebook"
            className="flex items-center justify-center  rounded-full sm:w-10 sm:h-10  text-gray-100"
          >
            <svg
          ...
          <a
            target={"_blank"}
            rel="noreferrer"
            href="https://www.instagram.com/dipropaul032/"
            title="Instagram"
            className="flex items-center justify-center  rounded-full sm:w-10 sm:h-10  text-gray-100"
          >
            <svg
      ...
      <motion.div className="absolute bottom-28 left-50 z-1 background_glow rounded-full w-[40%] h-[40%]"></motion.div>
    </div>
  );
};
