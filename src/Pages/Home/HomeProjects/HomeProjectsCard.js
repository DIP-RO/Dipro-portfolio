      ...
      <div className=" rounded  bg-[#000916]  shadow-2xl ">
        ...
        <div className="p-4">
          <div className="z-50 my-4 text-start ">
            ...
            <p className="w-70">
              {details}
              <Link className="" to={`/projects/${_id}`}>
                ...
              </Link>
            </p>
          </div>
          <div className="my-4">
            <h1 className="font-semibold text-start text-xl my-2  text-white">
              Features
            </h1>
            {/* <ul >
                            {
          ...
          <div className="text-start text-white flex justify-between">
            <Link to={`/projects/${_id}`}>
              <button
                type="button"
                className="my-4 px-5 py-2 rounded font-semibold bg-gradient-to-r from-indigo-600 to-pink-600 text-white  text-text-white"
              >
                Details
              </button>
            </Link>
            <a rel="noreferrer" target="_blank" href={live_web}>
              <button
                type="button"
                className="my-4 px-4 py-2 rounded font-semibold bg-gradient-to-r from-fuchsia-600 to-blue-500 text-white"
              >
                Live Web
              </button>
            </a>
